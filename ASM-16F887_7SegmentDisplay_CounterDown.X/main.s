;*******************************************************************************
;*
;*   Control de display de 7 segmentos: Contador desendente de 9 a 0
;*
;*******************************************************************************
;* FileName:        main.asm
;* Processor:       PIC16F887
...
;* Description:     Contador desendente con un display de 7 segmentos 
...
MCUInit:
    ...
    BSF     TRANSISTOR2		;Set transistor = 1
    ...
    MOVLW   10
    MOVWF   BANKMASK(CounterDisplay)	;Clear CounterDisplay
...
RESTARTCounter:
    MOVLW   9	    
    MOVWF   CounterDisplay	; CounterDisplay = 9
    GOTO    UPDATEDisplay
